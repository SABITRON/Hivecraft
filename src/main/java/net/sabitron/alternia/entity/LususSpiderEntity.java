...
public class LususSpiderEntity extends TamableAnimal {
	public LususSpiderEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AlterniaModEntities.LUSUS_SPIDER.get(), world);
	}

	public LususSpiderEntity(EntityType<LususSpiderEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(2f);
		xpReward = 8;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new TemptGoal(this, 1, Ingredient.of(AlterniaModItems.LUSUS_MEAT.get()), false));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		LususSpiderEntity retval = AlterniaModEntities.LUSUS_SPIDER.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(new ItemStack(AlterniaModItems.LUSUS_MEAT.get())).test(stack);
	}
