...
public class LususRamEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(LususRamEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(LususRamEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(LususRamEntity.class, EntityDataSerializers.STRING);
	...
	public LususRamEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AlterniaModEntities.LUSUS_RAM.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new TemptGoal(this, 1, Ingredient.of(AlterniaModItems.SHATTERGRAIN.get()), false));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		LususRamEntity retval = AlterniaModEntities.LUSUS_RAM.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(LususRamEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
