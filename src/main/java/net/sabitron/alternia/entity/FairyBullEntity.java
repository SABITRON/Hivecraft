...
import net.sabitron.alternia.procedures.FairyBullHurtAnimationProcedure;
...
public class FairyBullEntity extends TamableAnimal implements GeoEntity {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(FairyBullEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(FairyBullEntity.class, EntityDataSerializers.STRING);
	...
	public FairyBullEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AlterniaModEntities.FAIRY_BULL.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "fairy_bull");
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		FairyBullHurtAnimationProcedure.execute(this);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		FairyBullEntity retval = AlterniaModEntities.FAIRY_BULL.get().create(serverWorld);
	...
	private PlayState attackingPredicate(AnimationState event) {
		...
		if (this.swinging && event.getController().getAnimationState() == AnimationController.State.STOPPED) {
			...
			return event.setAndContinue(RawAnimation.begin().thenPlay("animation.fairy_bull.attack"));
		}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(FairyBullEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
