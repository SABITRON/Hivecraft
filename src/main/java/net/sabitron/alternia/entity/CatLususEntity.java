...
public class CatLususEntity extends TamableAnimal {
	public CatLususEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AlterniaModEntities.CAT_LUSUS.get(), world);
	}

	public CatLususEntity(EntityType<CatLususEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(1.2f);
		xpReward = 0;
		setNoAi(false);
