...
public class LususCrabEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(LususCrabEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(LususCrabEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(LususCrabEntity.class, EntityDataSerializers.STRING);
	...
	public LususCrabEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AlterniaModEntities.LUSUS_CRAB.get(), world);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		LususCrabEntity retval = AlterniaModEntities.LUSUS_CRAB.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(AlterniaModItems.RAW_GRUB_MEAT.get(), AlterniaModItems.LIVE_GRUB.get()).contains(stack.getItem());
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(LususCrabEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
