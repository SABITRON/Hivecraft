...
public class LususCatEntity extends TamableAnimal {
	public LususCatEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AlterniaModEntities.LUSUS_CAT.get(), world);
	}

	public LususCatEntity(EntityType<LususCatEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(1f);
		xpReward = 4;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		LususCatEntity retval = AlterniaModEntities.LUSUS_CAT.get().create(serverWorld);
