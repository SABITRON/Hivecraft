...
public class SpiderLususEntity extends TamableAnimal {
	public SpiderLususEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AlterniaModEntities.SPIDER_LUSUS.get(), world);
	}

	public SpiderLususEntity(EntityType<SpiderLususEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(2f);
		xpReward = 10;
		setNoAi(false);
