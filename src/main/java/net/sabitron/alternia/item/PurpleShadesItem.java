...
public abstract class PurpleShadesItem extends ArmorItem {
	public PurpleShadesItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends PurpleShadesItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "alternia:textures/entities/purple_shades.png";
		}
