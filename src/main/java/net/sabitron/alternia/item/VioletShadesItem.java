...
public abstract class VioletShadesItem extends ArmorItem {
	public VioletShadesItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends VioletShadesItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "alternia:textures/entities/violet_shades.png";
		}
