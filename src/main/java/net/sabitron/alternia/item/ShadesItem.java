...
public abstract class ShadesItem extends ArmorItem {
	public ShadesItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends ShadesItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "alternia:textures/entities/shades.png";
		}
