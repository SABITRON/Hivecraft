...
import net.sabitron.alternia.item.CookedGreenMushroomItem;
...
public class AlterniaModItems {
	...
	public static final RegistryObject<Item> GREEN_MUSHROOM = block(AlterniaModBlocks.GREEN_MUSHROOM);
	public static final RegistryObject<Item> GREEN_SPORES = block(AlterniaModBlocks.GREEN_SPORES);
	public static final RegistryObject<Item> COOKED_GREEN_MUSHROOM = REGISTRY.register("cooked_green_mushroom", () -> new CookedGreenMushroomItem());
