...
public class AlternianSoilUseHoeProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, BlockState blockstate, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() instanceof HoeItem) {
			if (blockstate.getBlock() == AlterniaModBlocks.ALTERNIAN_SOIL.get() || blockstate.getBlock() == AlterniaModBlocks.ALTERNIAN_GRASS_BLOCK.get()) {
				if (entity instanceof LivingEntity _entity)
					_entity.swing(InteractionHand.MAIN_HAND, true);
				world.setBlock(BlockPos.containing(x, y, z), AlterniaModBlocks.ALTERNIAN_FARMLAND.get().defaultBlockState(), 3);
