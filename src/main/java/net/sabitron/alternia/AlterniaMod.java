...
@Mod("alternia")
public class AlterniaMod {
	public static final Logger LOGGER = LogManager.getLogger(AlterniaMod.class);
	public static final String MODID = "alternia";
	...
	public AlterniaMod() {
		...
		AlterniaModFluids.REGISTRY.register(bus);
		AlterniaModFluidTypes.REGISTRY.register(bus);
	}
